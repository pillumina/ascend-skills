...
![11-stage analysis pipeline](../docs/ascend-inference-profiling/pipeline-stages.jpg)
...
![7 config signature detections](../docs/ascend-inference-profiling/config-signatures.jpg)
...
![Remote SSH vs local direct execution](../docs/ascend-inference-profiling/execution-model.jpg)
...
![Agent interaction flow](../docs/ascend-inference-profiling/agent-interaction.jpg)
...
![Three-layer knowledge architecture](../docs/ascend-inference-profiling/knowledge-architecture.jpg)
...
![A2 vs A3 hardware architecture](../docs/ascend-inference-profiling/hardware-architecture.jpg)
