...
![11-stage analysis pipeline](../docs/ascend-inference-profiling/pipeline-stages.webp)
...
![7 config signature detections](../docs/ascend-inference-profiling/config-signatures.webp)
...
![Remote SSH vs local direct execution](../docs/ascend-inference-profiling/execution-model.webp)
...
![Agent interaction flow](../docs/ascend-inference-profiling/agent-interaction.webp)
...
![Three-layer knowledge architecture](../docs/ascend-inference-profiling/knowledge-architecture.webp)
...
![A2 vs A3 hardware architecture](../docs/ascend-inference-profiling/hardware-architecture.webp)
